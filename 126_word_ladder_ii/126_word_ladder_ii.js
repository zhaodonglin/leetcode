...
var findLadders = function(beginWord, endWord, wordList) {
	...
	while(1) {	
		...
		if (is_end_word_find){return result_paths;}
		i = 0;
	}
	
};

console.log("findladders",findLadders("hit", "cog", ["hot","dot","dog","lot","log","cog"]));
console.log("findladders2",findLadders("hit", "cog", ["hot", "dot", "dog", "lot", "log"]));
console.log("findLadders3",findLadders("a", "c", ["a", "b", "c"]));
